...
const productos = [
    {
        ...
        imagen:'./img/laboratorioIMG/78-1.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/78HW-1.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/HS-17.jpg',
        descripcion:'CaracterísticasPrincipales: <br/> <br/> - Placa calefactora: Confeccionada en aluminio con protección cerámica anticorrosión. <br/> - Medidas de la placa calefactora: 17 x 17cm. <br/> - Rango de temperatura de funcionamiento: Temperatura ambiente +5°C hasta 300 °C. Precisión: ±5°C. <br/> - Regulación de RPM velocidad: 0-1600 rpm. <br/> - Volumen de agitación de H2O: 3 Litros. <br/> - Protección: Posee circuito de seguridad de sobre temperatura. <br/> - Alimentación: 220V 50Hz. <br/> - Temperatura ambiente y humedad permitidas: 5-40 °C, 80% de humedad relativa. <br/> - Ideal para ser utilizada en laboratorio, industria, biología y educación.'
    },
    {
        id:'5',
        subCategoriaID:'1',
        ...
        imagen:'./img/laboratorioIMG/HS-19T.png',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/AG1200.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/AG1200C.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/MS3.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/MS5.jpg',
    ...
    },
    {
        ...
        subCategoriaID:'5',
        modelo:'TC-800M',
        nombre:'CABEZAL TERMOSTATICO MARCA OBERTEC MODELO TC-800M',
        imagen:'./img/laboratorioIMG/TC-800M.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/CENTRIFUGA800D.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/TDL4.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/MC-12PRO.jpg',
    ...
    // },
    {
        ...
        imagen:'./img/laboratorioIMG/PIPETA4.png',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/XSZ107BN.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/lupaSL10.jpg',
    ...
    },
    {
        ...
        imagen:'./img/laboratorioIMG/lupaST30.jpg',
    ...
    },
    {
        ...
        modelo:'TC-800B',
        nombre:'CABEZAL TERMOSTATICO MARCA OBERTEC MODELO TC-800B',
        imagen:'./img/laboratorioIMG/TC-800Ba.jpg',
    ...
    },
    {
        ...
        modelo:'TC-800M',
        nombre:'CABEZAL TERMOSTATICO MARCA OBERTEC MODELO TC-800M',
        imagen:'./img/laboratorioIMG/TC-800Mb.jpg',
        descripcion:'Características Principales:<br/><br/> - Gabinete: Construido en dos piezas. Base de en acero inoxidable, espesor 1.25mm. Tapa de aluminio espesor 2.0 mm con tratamiento de pintura hibrida en polvo Epoxy-Polyester. <br/>- Sistema calefactor. <br/>Electrocalefactor blindado compactado, construido en vaina de acero inoxidable AISI 316l diámetro 9 mm formato tipo “rulo” de 4 vueltas. <br/>- Potencia total 800 w 220 v. <br/>- Control de temperatura. <br/>- Control de temperatura electrónico, PID microcontrolador, panel frontal diseñado en POLYCARBONATO con controles SOFT TOUCH. <br/>- Variables de operación. <br/>- Funcionamiento: ON/OFF o proporcional derivativo. <br/>-Display de tres dígitos color rojo, Indicación de temperatura de proceso.  <br/>- Display inferior color verde Indicación de temperatura seleccionada. <br/> - Estabilidad de temperatura +/- 0,3º C. <br/> - Lectura de la temperatura. <br/>- Sensor PT100. <br/>- Rango de temperatura. Temperatura ambiente a 130°C. <br/> - Sistema de circulación de agua mediante bomba construida totalmente en AC/INOX motor de accionamiento silencioso con su eje montado sobre rodamientos. <br/>- Sistema de alarmas. <br/>- Alarma lumínico audible por sobre temperatura, con corte automático de potencia. <br/>- Alarma lumínico audible por falta de agua, con corte automático de potencia. <br/>- Sistema de iluminación. <br/>- Iluminación de la cuba por medio de leds de alto brillo (cuba no incluida). <br/> - Conexión 220V 50HZ/li> <br/>- Para ser utilizada en laboratorio, industria y educación.'
    },
]
...
const params = new URLSearchParams(window.location.search);
    ...
    const subcategoria = params.get('nombre');
    

  
    let productoSection = document.getElementById('producto');
    let categoriaProducto = document.getElementById('seleccionadoProductos');

    categoriaProducto.innerHTML = categoria
            ...
            `<div class="divProductoView">`+
               `<div class="division">`+ 
                    `<div class="divisonDiv">`+
                        ...
                        `<h5 class="categoriaSeleccionada"></h5>`+
                    `</div>`+
                    ...
                    `</div>`+
               `</div>`+
                `<div id=${producto.id} class="row divImagenLab">`+
                    `<div class="text-center">`+
                        `<div class="col-md-5 modeloText">`+
                        ...
                        `<div class="div-mobile col-sm-12 ">`+
                            ...
                            `</div>`+
                            `<div class="col-12 col-sm-12 col-md-7 div-imagen-producto">`+
                                `<img src=${producto.imagen} class="cambiarTamaño" alt="Laboratorio imagen producto"/>`+
                            `</div>`+
                        `</div>`+
                        `<div class="irArriba">`+
    ...
    let nombrecategoria = document.getElementsByClassName('categoriaSeleccionada');
    for (let i = 0; i < nombrecategoria.length; i++) {
        nombrecategoria[i].innerText = categoria;
        }
        
    let nombreSubcategoria = document.getElementsByClassName('seleccionadoLab');
    for (let i = 0; i < nombreSubcategoria.length; i++) {
        nombreSubcategoria[i].innerText = subcategoria;
      }
