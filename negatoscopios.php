	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-3">
					...
					<div><span class="glyphicon glyphicon-triangle-right"></span>Equipos para Laboratorio</div>
					<ul id="div-labor">
				...
				<nav class="nav-equipos">
					<div class="active"><span class="glyphicon glyphicon-triangle-right"></span>Iluminación</div>	
					<ul id="div-ilum">
						<li class="current"><span class="glyphicon glyphicon-stop"></span><a href="negatoscopios.php" title="Negatoscopios Tecnología Led">Negatoscopios Tecnología Led</a></li>
